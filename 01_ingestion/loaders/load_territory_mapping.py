# load_territory_mapping.py  (SRC-08, OneDrive, XLSX — region -> employee mapping)
import uuid
import time
import sys
sys.path.append('..')
...
FOLDER_PATH = 'TerritoryMapping'
TABLE_NAME = 'territory_mapping'
...
def run():
    ...
    if not files:
        print('Không tìm thấy file territory_mapping.xlsx')
        return
